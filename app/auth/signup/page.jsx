...
function Page() {
  ...
  return (
    <div className="signup-container">
      {/* Theme Toggle with icons instead of text */}
      ...
      <aside className="sidebar">
        ...
        <button className="sidebar-btn">
          🔹 Bite-size lessons and quizzes
        </button>
        <button className="sidebar-btn">
          🔸 Earn Health Points and badges
        </button>
      ...
      <main className="form-section">
        <div className="signup-card">
          <div className="card-header">
            ...
            <p className="muted">
              Start with a free profile. Track progress, earn points, and play
              in the lobby.
            </p>
          </div>
